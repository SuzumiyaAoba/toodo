...
// Define base task schema without circular references
...
// Task response schema with proper type definition using deferred reference
type TaskResponseSchema = z.ZodObject<{
	id: z.ZodString;
	title: z.ZodString;
